...
- At start of shift, audit all existing issues that have someone assigned to them, and make sure that none are being sat on for too long. Deassign the issue from the current assignee if there's no indication of progress or response to pings for > 7 days.
