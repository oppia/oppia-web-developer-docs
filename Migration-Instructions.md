...
Please note that the above information is provided for reference, but that if you are performing this migration, you do so at your own risk, and we cannot guarantee assistance if you run into problems. It might be prudent to run through the migration beforehand on a test server.
