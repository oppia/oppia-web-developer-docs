...
1. On your browser, consider [pinning](https://support.mozilla.org/en-US/kb/pinned-tabs-keep-favorite-websites-open) both this wiki page (for easy reference later) and the [Gitter tab](https://gitter.im/oppia/oppia-chat) (so that it's easily accessible and you can keep abreast of new activity). To pin a tab, just right-click the tab you want to pin, and select "Pin Tab".
