...
5. **Address review comments until all reviewers give LGTM ('looks good to me').**
  ...
  * **WARNING:** Do not make changes using the online GitHub editor -- this bypasses lint/presubmit checks, and will result in the code on GitHub diverging from the code on your machine. Always make commits locally, and then push to GitHub.
