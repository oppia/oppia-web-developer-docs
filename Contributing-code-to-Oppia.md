...
4. **When your feature is ready to merge, create a pull request.**
  ...
  * **Important:** Manually check the "Files changed" tab on your PR on GitHub to make sure that the list of files you want to submit, and the changes you want to make to each, are correct -- e.g., that you haven't left additional console logging statements in them, or left out important files. (If not, please fix this by making additional commits, or by closing this PR and submitting a new one, before requesting a review.)
