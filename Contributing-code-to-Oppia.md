...
Also, feel free to just search the issue tracker for something that looks interesting -- we particularly recommend issues from the ["Recommended Projects" milestone](https://github.com/oppia/oppia/milestone/42). Try to pick a project that someone else isn't already working on.
