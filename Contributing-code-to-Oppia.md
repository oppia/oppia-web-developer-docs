...
To get familiar with Oppia from an operational point of view, do check out [user documentation](http://oppia.github.io/).
...
- Git and Github are used to make changes to the repository. So, it's good know how to use them to do basic stuff like branching, merging, pull/push etc. [Here](https://github.com/oppia/oppia/wiki/Learning-Resources) is the link where a few of the learning materials are referred.
- Consider learning AngularJS (v1), if you're new to it. A nice youtube video tutorial can be found [here](https://www.youtube.com/watch?v=nO1ROKMjPqI&list=PLvZkOAgBYrsS_ugyamsNpCgLSmtIXZGiz) and you can check the the official [tutorial](https://docs.angularjs.org/tutorial/index)/[guide](https://docs.angularjs.org/guide), also for a outline of AngularJS you can take a look into this [short overview](https://egghead.io/articles/new-to-angularjs-start-learning-here) with pointers to other resources. Most of our open issues are in the frontend, and require at least some knowledge of HTML, AngularJS and CSS, so knowledge of frontend coding will serve you well if you'd like to contribute to Oppia over the longer term.
