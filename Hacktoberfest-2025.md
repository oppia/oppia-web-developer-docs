# 🎉 Oppia + Hacktoberfest 2025

Oppia is excited to be joining the rest of the GitHub community in participating in this year's [Hacktoberfest](https://hacktoberfest.com/)! 🎉
...
1. [Register for Hacktoberfest](https://hacktoberfest.com/register/) anytime between **September 15 and October 31**.
2. [Set up your development environment](https://github.com/oppia/oppia/wiki/Contributing-code-to-Oppia#setting-things-up) for contributing to Oppia.
...
Want to support Oppia beyond code? Check out the [Hacktoberfest donations page](https://hacktoberfest.com/donate/) or support us via our [GitHub Sponsors](https://github.com/sponsors/oppia). Every bit helps grow the project and our impact!
