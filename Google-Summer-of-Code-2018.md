...
1. When you've done enough starter projects to get a good understanding for the "lay of the land", select one or more GSoC projects that you're most interested in, and write your project proposal! We strongly encourage you to discuss your project ideas and share your proposal with the community. The community will help make sure your proposal is going in the right direction and help you concentrate on the important parts. To get community feedback, you'll need to share your proposal with the community so they can add comments. The preferred way for this to happen is by putting your proposal into a collaborative editing tool like Google Docs and sharing a link to it on the [GSoC discussion mailing list](mailto:oppia-gsoc-discuss@googlegroups.com). Also, if you have any questions about a project or would like to discuss your approach with the Oppia community and get feedback, feel free to email the [GSoC discussion mailing list](mailto:oppia-gsoc-discuss@googlegroups.com). Please be specific when asking questions, since this makes it easier for us to help you.
