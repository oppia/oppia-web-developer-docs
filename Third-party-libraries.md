...
* [ ] **No binary artifacts:** Binary artifacts are acceptable if they are so obviously not for use in production or not supposed to contain code that any production code referencing them would be obviously dangerous to a reviewer (e.g. image files or test assets).
...
* [ ] **We have manually reviewed the source code for the dependency and confirmed that it is safe:**
...
* [ ] **Actively maintained based on recent release history:**
